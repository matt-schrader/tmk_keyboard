...
The homepage for this package may be found at the following URL:
https://geekhack.org/index.php?topic=51252

If you need help, go to that address and read the FAQ.  IF you still need help,
post your question in that Geekhack thread.

===================
Creating A Keymap
=================

If you're reading this, you already managed to download the package and unzip
it.  Launch easy_keymap.exe in Windows, or run 'python main.py' if you're using
