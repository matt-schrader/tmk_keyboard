...
led_map = 0x00001e1d
bl_mask_map = 0x00001e12

pw_defs_map = 0x00001e7c

led_hw_map = 0x00001e2d
row_hw_map = 0x00001e70
col_hw_map = 0x00001e4e
#autogen finish
...
keyboard_definition = [
    ...
    [((9, 4), (4, 0), 'HID_KEYBOARD_SC_LEFT_SHIFT'),
     ...
     ((4, 4), (4, 13), 'HID_KEYBOARD_SC_APPLICATION'),
     (5, None, '0'),
    ...
    [((6, 4), (5, 0), 'HID_KEYBOARD_SC_LEFT_CONTROL'),
     ...
     ((28, 4), (5, 6), 'HID_KEYBOARD_SC_SPACE'),
     ((6, 4), (5, 10), 'HID_KEYBOARD_SC_RIGHT_ALT'),
     ((4, 4), (5, 11), 'HID_KEYBOARD_SC_RIGHT_GUI'),
     ((6, 4), (5, 12), 'HID_KEYBOARD_SC_RIGHT_CONTROL'),
     (1, None, '0'),
...
if __name__ == '__main__':
    print("Keyboard definition for Sigma keyboard")
