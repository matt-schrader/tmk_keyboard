...
#autogen start
layers_map = 0x00000972

actions_map = 0x000005b2

tapkeys_map = 0x000001f2

macro_map = 0x00000d32

led_map = 0x00001d6e
bl_mask_map = 0x00001d62

pw_defs_map = 0x00001dce

led_hw_map = 0x00001d7e
row_hw_map = 0x00001dc2
col_hw_map = 0x00001da2
#autogen finish

led_definition = [
    ('Esc Key', 'Backlight'),
    ('PrtScn Key', 'Backlight'),
...
keyboard_definition = [
    ...
    [((6, 4), (2, 0), 'HID_KEYBOARD_SC_TAB'),
     ...
     ((4, 4), (2, 15), 'HID_KEYBOARD_SC_PAGE_DOWN')],
    ...
    [((7, 4), (3, 0), 'HID_KEYBOARD_SC_CAPS_LOCK'),
     ...
     ((4, 4), (3, 14), 'HID_KEYBOARD_SC_HOME'),
     ((4, 4), (3, 15), 'HID_KEYBOARD_SC_END')],
    ...
    [((9, 4), (4, 0), 'HID_KEYBOARD_SC_LEFT_SHIFT'),
     ...
     ((11, 4), (4, 12), 'HID_KEYBOARD_SC_RIGHT_SHIFT'),
     ((4, 4), (4, 14), 'HID_KEYBOARD_SC_UP_ARROW'),
     ((4, 4), (4, 15), 'HID_KEYBOARD_SC_APPLICATION')],
    ...
    [((5, 4), (5, 0), 'HID_KEYBOARD_SC_LEFT_CONTROL'),
     ...
     ((5, 4), (5, 12), 'HID_KEYBOARD_SC_RIGHT_CONTROL'),
     (1, None, '0'),
...
if __name__ == '__main__':
    print("Keyboard definition for Zeta keyboard")
