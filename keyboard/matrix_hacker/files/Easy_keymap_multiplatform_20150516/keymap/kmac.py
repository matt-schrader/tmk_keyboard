...
led_map = 0x00002007
bl_mask_map = 0x00002000

pw_defs_map = 0x0000202c

led_hw_map = 0x00002017
row_hw_map = 0x00002106
col_hw_map = 0x000020e4
#autogen finish
...
keyboard_definition = [
    ...
    [((7, 4), (6, 0), 'HID_KEYBOARD_SC_CAPS_LOCK'),
...
if __name__ == '__main__':
    print("Keyboard definition for KMAC keyboard")
