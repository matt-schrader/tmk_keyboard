...
#autogen start
layers_map = 0x00000a26

actions_map = 0x0000060c

tapkeys_map = 0x000001f2

macro_map = 0x00000e40

led_map = 0x00001ed9
bl_mask_map = 0x00001ed0

pw_defs_map = 0x00001f04

led_hw_map = 0x00001ee9
row_hw_map = 0x00002016
col_hw_map = 0x00001ff8
#autogen finish
...
keyboard_definition = [
    [((4, 4), (0, 0), 'HID_KEYBOARD_SC_ESCAPE'),
     ...
     ((4, 4), (0, 13), 'HID_KEYBOARD_SC_SCROLL_LOCK'),
    ...
    [((7, 4), (3, 0), 'HID_KEYBOARD_SC_CAPS_LOCK'),
     ...
     ((4, 4), (3, 14), 'HID_KEYBOARD_SC_PAGE_DOWN')],
    ...
    [((9, 4), (4, 0), 'HID_KEYBOARD_SC_LEFT_SHIFT'),
     ...
     ((4, 4), (4, 13), 'HID_KEYBOARD_SC_UP_ARROW'),
     ((4, 4), (4, 14), 'HID_KEYBOARD_SC_END')],
    ...
    [((5, 4), (5, 0), 'HID_KEYBOARD_SC_LEFT_CONTROL'),
     ...
     ((4, 4), (5, 8), 'HID_KEYBOARD_SC_RIGHT_ALT'),
     ((4, 4), (5, 10), 'HID_KEYBOARD_SC_RIGHT_GUI'),
     ((4, 4), (5, 11), 'HID_KEYBOARD_SC_RIGHT_CONTROL'),
     ((4, 4), (5, 12), 'HID_KEYBOARD_SC_LEFT_ARROW'),
...
if __name__ == '__main__':
    print("Keyboard definition for Octagon keyboard")
